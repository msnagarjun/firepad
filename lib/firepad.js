...
firepad.Firepad = (function(global) {
  ...
  Firepad.prototype.small = function() {
    this.richTextCodeMirror_.toggleAttribute(ATTR.FONT_SIZE, '1em');
    this.codeMirror_.focus();
  };

  Firepad.prototype.medium = function() {
    this.richTextCodeMirror_.toggleAttribute(ATTR.FONT_SIZE, '1.5em');
    this.codeMirror_.focus();
  };

  Firepad.prototype.large = function() {
    this.richTextCodeMirror_.toggleAttribute(ATTR.FONT_SIZE, '2em');
    this.codeMirror_.focus();
  };
  ...
  Firepad.prototype.addToolbar_ = function() {
    ...
    this.toolbar.on('small', this.small, this);
    this.toolbar.on('medium', this.medium, this);
    this.toolbar.on('large', this.large, this);
