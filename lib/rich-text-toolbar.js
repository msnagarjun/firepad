// Customising RichTextToolbar for MeetM
// Author: Nagarjun M S 
// Date: 5th December 2016
// Task: Remove Font Size and add Dropdown like medium.com
...
firepad.RichTextToolbar = (function(global) {
  ...
  utils.makeEventEmitter(RichTextToolbar, ['small', 'medium', 'large', 'bold', 'italic', 'underline', 'strike', 'font', 'font-size', 'color',
  ...
  RichTextToolbar.prototype.makeElement_ = function() {
    ...
    var toolbarOptions = [
      ...
      utils.elt('div', [self.makeButton_('small'), self.makeButton_('medium'), self.makeButton_('large')], { 'class': 'firepad-btn-group'}),
  ...
  RichTextToolbar.prototype.makeFontSizeDropdown_ = function() {
    // NOTE: There must be matching .css styles in firepad.css.
    var sizes = [9, 10, 12, 14, 18, 24, 32, 42, 52];
